...
public class TC_05_proceedtocheckoutpage extends BaseClass {
   
	@Test
	public void proceedtocheckoutpage() throws IOException {
		 LoginPage p1=new LoginPage(driver);
		    ...
		    captureScreenShot(driver, "TC_05_proceedtocheckoutpage");
	}
}

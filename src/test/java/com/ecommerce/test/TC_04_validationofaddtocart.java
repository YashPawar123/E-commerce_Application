...
public class TC_04_validationofaddtocart extends BaseClass
{
    
	@Test
	public void validationofaddtocart() throws IOException
	{
	    ...
	    gotocart.click();
	    captureScreenShot(driver, "TC_04_validationofaddtocart");
	}
}

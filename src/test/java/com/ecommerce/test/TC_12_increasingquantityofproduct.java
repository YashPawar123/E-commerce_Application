...
public class TC_12_increasingquantityofproduct extends BaseClass {
    
	@Test
	public void increasingquantity() throws IOException
	{LoginPage p1=new LoginPage(driver);
	    ...
	    WebElement addtocart= driver.findElement(By.xpath(" //input[@id='add-to-cart-button']"));
	     ...
	     for (WebElement option : quantity)
	     {
		    ...
		    captureScreenShot(driver, "TC_12_increasingquantityofproduct");
